...
[#img-addapptcommand]
. Type the example command into the input box as follows in Figure 1 and hit the kbd:[Enter] key:
...
[#img-addapptresult]
[start=2]
. The resulting output will be as shown in Figure 2:
...
[#img-registercommand]
. Type the example command into the input box as follows in Figure 3 and hit the kbd:[Enter] key:
